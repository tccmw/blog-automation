...
- Reorganize the source into a clearer Notion-friendly version.
...
- Write in the same language as the source page unless the source clearly asks for another language.
- Do not add icons, emojis, callout icons, or decorative prefixes.
